<template>
  <div class="publish">
    ...
    <el-row class="mt-15" :gutter="15">
      <el-col :span="12">
        <el-button class="full-width" type="primary" plain size="large" :loading="props.loading" :disabled="disabled"
          @click="emits('changeStatus', WORLD_STATUSES.DRAFT)">Save Draft</el-button>
      </el-col>
      <el-col :span="12">
        <el-button class="full-width" type="primary" plain size="large" :disabled="!world" @click="onPreview">Preview
        </el-button>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="15">
      <el-col :span="12">
        <el-button class="full-width" type="primary" link size="large" :loading="props.loading" :disabled="disabled"
          @click="emits('changeStatus', WORLD_STATUSES.ARCHIVE)">Archive World</el-button>
      </el-col>
      <el-col :span="12">
  ...
  <WorldLoadingModal v-if="world" :show-modal="isWorldLoadingModal" :world="world"
