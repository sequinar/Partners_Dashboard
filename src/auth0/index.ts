...
import {
  App, Plugin, computed, reactive, watchEffect,
} from 'vue';
...
function logout(t: LogoutOptions) {
  //const o = t;
  let o = {returnTo : window.location.origin};
  //o.returnTo = ;
...
const routeGuard: NavigationGuardWithThis<undefined> = (to: any, from: any, next: any) => {
  ...
  watchEffect(() => (loading.value ? undefined : verify()));
